...
<head>
  ...
  <style>
    ...
    .logo-container { margin-bottom:20px; animation: float 3s ease-in-out infinite; }
    .logo img { width: 70px; height: 70px; border-radius: 50%; }

    h1 { margin:15px 0 10px; font-size:28px; color:#ffffff; font-weight:700; letter-spacing:0.5px; }
    .subtitle { font-size:14px; color:rgba(255,255,255,0.85); margin-bottom:30px; font-weight:400; line-height:1.6; }
    ...
    @media (max-width:480px){
      .container { max-width:100%; margin:16px; padding:30px 20px; }
      h1 { font-size:24px; }
      .link { padding:14px 18px; }
    }
  </style>
</head>
<body>
